...
# Set the servo motor pin as an output pin
...
while True:
    ...
    # Convert accelerometer X axis values from 0 to 180   
    value = (Ax - in_min) * (out_max - out_min) / (in_max - in_min) + out_min
    value = int(value)

    # Agregar un mensaje de texto antes de imprimir el valor del ángulo del eje X
    print("El ángulo del eje X es:", value)
